...
@Component({
  selector: 'app-join-non-secured',
  templateUrl: './join-non-secured.component.html',
  styleUrls: ['./join-non-secured.component.css']
})
export class JoinNonSecuredComponent implements OnInit {
  ...
  onJoinNonSecuredGroup(joinGroupRequest: SearchGroupRequest) {

    joinGroupRequest.groupName = this.parentComponentData.group.title
    joinGroupRequest.password = ""
